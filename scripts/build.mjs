...
const platforms = [
  ...
  {name:'Facebook', detail:'Contenido · Anuncios · Promociones', icon:'assets/icons/social/vumari-social-facebook.png'},
  {name:'TikTok', detail:'Videos verticales · Tendencias', icon:'assets/icons/social/vumari-social-tiktok.png'},
  {name:'YouTube', detail:'Videos · Miniaturas · Entrevistas', icon:'assets/icons/tools/vumari-tool-youtube.png'},
  {name:'YouTube Shorts', detail:'Videos breves · Series', icon:'assets/icons/platforms/vumari-platform-youtube-shorts.png'},
  {name:'X', detail:'Actualizaciones · Piezas gráficas', icon:'assets/icons/social/vumari-social-x.png'},
  {name:'WhatsApp', detail:'Catálogos · Contenido promocional', icon:'assets/icons/social/vumari-social-whatsapp.png'}
];
...
const tools = [
  {name:'Canva', icon:'assets/icons/tools/vumari-tool-canva.png'},
  {name:'CapCut', icon:'assets/icons/tools/vumari-tool-capcut.png', monochrome:true},
  {name:'YouTube', icon:'assets/icons/tools/vumari-tool-youtube.png'},
  {name:'Meta', icon:'assets/icons/tools/vumari-tool-meta.png'},
  {name:'Google', icon:'assets/icons/tools/vumari-tool-google.png'},
  {name:'GitHub', icon:'assets/icons/tools/vumari-tool-github.png', monochrome:true}
];
