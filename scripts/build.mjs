...
const pages = [
  {
    ...
    content:`<section class="hero"><div class="container hero-grid"><div class="hero-copy"><p class="eyebrow">Estudio creativo · Tres Valles, Veracruz</p><h1>Ideas que toman <span class="gradient-text">forma y presencia.</span></h1><p class="lead">${company.description}</p><div class="actions"><a class="button button--primary" href="servicios.html">Conoce nuestros servicios</a>${quoteButton}</div></div><img class="hero-mark" src="assets/images/brand/vumari-logo-primary.png" alt="Logotipo multicolor de VUMARI STUDIOS" width="1122" height="1402" fetchpriority="high"></div></section>
    ...
    <section class="section section--soft"><div class="container"><div class="section-heading"><p class="eyebrow">Proceso</p><h2>Claridad desde la primera conversación.</h2><p>Los tiempos y entregables se definen en cada propuesta según el alcance.</p></div><ol class="grid grid--3">${processCards}</ol></div></section>
